    ...
    <>
      <div className="w-full h-screen">
        <div className="p-4 w-full h-5">
          <h1 className="relative text-4xl font-bold text-white tracking-wide mb-12 pb-2">
            Habit Tracker
          ...
          <div className="flex border bg-[#426B69]/5  border-black rounded-lg max-h-82 w-full items-center ">
